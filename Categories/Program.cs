...
class Category : ICategory
{
    ...
    //List<IProduct> ICategory.Products { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }

    //void ICategory.AddProduct(IProduct product)
    //{
...
class Company : ICompany
{
    ...
    {
        return Categories.OrderByDescending(x => x.Products.Count())?.FirstOrDefault()?.Name;
    }
